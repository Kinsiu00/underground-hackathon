...
class Action:
    ...
    def interaction(self, key):
        ...
        for per_scene in self.scene_trigger:
            ...
            if key == 'Hail a cab':
                dead_taxi = [
                inquirer.Text('answer', message="Enter the address of the location")
                ]
...
# Different Scenes
penn_station = Scene('You are in the heart of New York City\'s transit system - Penn Station.\nAround you is a sea of people too busy going about their daily routines to notice you.\nThe monitors change rapidly to reflect the hundreds of trains coming into and out of the city.',
                     "You are standing in Penn Station",
                     ['Glance at the MTA Schedule', 'Grab a bite to eat', 'Wander the station', 'Head to Times Square', 'Hail a cab', 'Check your pocket'])

times_square = Scene('Before you is the heart of New York City - massive, bright displays and billboards surround you,\nselling you the answer to all of life\'s problems. The din of the city is overwelming here.\nYou notice a (mostly) naked cowboy strumming a guitar, as well as an odd, solitary poster on a wall.',
                     "You are standing at the center of the world",
                     {'Check out the Naked Cowboy.', 'Look for the White Rabbit', 'Read Poster', 'Go to Penn Station', 'Check your pocket'})

dead_rabbit = Scene('The Dead Rabbit is a slick and modern bar, with the proper ambiance for a good first impression,\nromantic or otherwise. It is currently not busy, the bartender is idily wiping down a glass,\nyou can almost make out a faint humming slip through her lips.',
                    "Music is playing faintly",
                    ['Chat with the Bartender', 'Ask about White Rabbit', 'Order the Blue cocktail',
                     'Order the Red cocktail', 'Head to Times Square', 'Check your pocket'])

rabbit_tattoo = Scene('The tattoo parlor is clean and neat, the walls are adorn with tattoo samples.\nA heavy-set man is busy concentrating on tattooing a face-down customer.', 'A tattoo gun buzzes softly in the background', ['Ask about White Rabbit', 'Get a Tattoo', 'Ask about Underground Hackathon','Head to Times Square', 'Check your pocket'])


penn_station_actions = Action({'Glance at the MTA Schedule': 'you see:',
                               ...
                               'Check your pocket': '..nothing else'}, {'Head to Times Square', 'puff the magic dragon'})

times_square_actions = Action({'Check out the Naked Cowboy.': 'He continues to strum his guitar and gives you a wink.',
                               ...
                               'Go to the White Rabbit Tattoo Parlor': 'You head for the Tattoo Parlor', 'Check your pocket': '..nothing else'}, {'Look for the White Rabbit', 'Go to Penn Station', 'Go to Dead Rabbit Bar', 'Go to the White Rabbit Tattoo Parlor'})

dead_rabbit_action = Action({'Chat with the Bartender': "'There's a rumor of a secret metro station at 9 and 3/16th st, whatever that means.', she confides.",
                             ...
                             'Head to Times Square': "You head back to Times Square", 'Check your pocket': '..nothing else'}, {'Order the Blue cocktail'})

rabbit_tattoo_action = Action({'Ask about White Rabbit':'"I don\'t know anything about that", the man states flately, never taking his eyes away from his work.\n"Try asking at that something Rabbit Bar, a cab should be able to take you."', 'Get a Tattoo':'"Sorry, all booked up, come back tomorrow.", the man says.', 'Ask about Underground Hackathon':'"What is that? Look buddy, we just do tattoos here"', 'Head to Times Square': 'you leave', 'Check your pocket': '..nothing else'},{'Head to Times Square'})
...
scene_list = {'Head to Times Square': times_square,
              'Go to Penn Station': penn_station, 'Go to Dead Rabbit Bar': dead_rabbit}
